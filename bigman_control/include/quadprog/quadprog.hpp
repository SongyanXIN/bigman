#ifndef _QUADPROG_HPP_
#define _QUADPROG_HPP_
...
/*
 ...
 The quadprog() function solve a Quadratic Programming problem defined as:
...
inline double quadprog(MatrixXd &H,  VectorXd &f,  
                const MatrixXd &A, const VectorXd &b,  
                const MatrixXd &Aeq, const VectorXd &beq, 
                VectorXd &x){

  // Interface according to matlab QP definition:
  // min 0.5*X^T*H*X + f^T*X;
  // s.t. 
  //     A*X <= b
  //     Aeq*X = beq
